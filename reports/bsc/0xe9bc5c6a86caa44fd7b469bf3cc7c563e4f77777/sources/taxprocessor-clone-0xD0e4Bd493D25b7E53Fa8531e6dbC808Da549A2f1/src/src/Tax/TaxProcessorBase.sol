...
contract TaxProcessorAdminImpl is TaxProcessorBaseStorage {
    ...
    ///         on-chain dust floor `minBuyBackQuote` as 50% of the returned value.
    ///         ┌──────────────────┬─────────────────────────┬──────────────┐
    ...
    function initialize(TaxProcessorV2InitParams memory params) public initializer {
        ...
        // On-chain dust floor is 50% of the keeper dispatch signal (uniform across all chains/tokens).
        minBuyBackQuote = (dispatchThreshold * 50) / 100;
